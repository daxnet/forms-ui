...
namespace FormsUI.Extensions
{
    ...
    public abstract class ExternalResourceManager<TResource>
        where TResource : class, IResource
    {
        ...
        {
            this.ResourceLoaded?.Invoke(this, new ExternalResourceLoadEventArgs<TResource>(resource));
        }
        ...
        /// The resources.
        /// </value>
        protected Dictionary<Guid, TResource> Resources { get; } = new Dictionary<Guid, TResource>();
        #endregion
